...
<div class="cvt" id="ctvw">
    <div class="section-containert">
        ...
        <div class="section-contentt">
            <p><strong>ASUNTO:</strong> {{$matriz['datos']->asunto}}</p>
            <p><strong>Detalle:</strong> {{$matriz['datos']->detalle}}</p>
            <p><strong>Prevención:</strong> {{$matriz['datos']->prevencion}}</p>
        </div>
    </div>
    ...
    <div class="section-containert gray-backgroundt">
        ...
        <div class="section-contentt">
            <p><strong>Nombre:</strong> {{$matriz['depen']->Solicitudmantenimineto['nombre_apellido']}}</p>
            <p><strong>Cédula:</strong> {{$matriz['depen']->Solicitudmantenimineto['identificacion']}}</p>
            <p><strong>Fecha de la solicitud:</strong> {{$matriz['depen']->Solicitudmantenimineto['created_at']}}</p>
        </div>
    </div>
    ...
    <div class="section-containert gray-backgroundt">
        ...
        <div class="section-contentt">
            <p><strong>Nombre:</strong> {{$matriz['datos']->Personal['nombre_apellido']}}</p>
            <p><strong>Cédula:</strong> {{$matriz['datos']->Personal['identificacion']}}</p>
        </div>
    </div>
    ...
    <div class="section-containert">
        ...
        <div class="section-contentt">
            <p><strong>Tipo:</strong> {{$matriz['datos']->Tipomantenimento['tipo_mantenineto']}}</p>
            <p><strong>Fecha de Orden de Trabajo:</strong> {{$matriz['datos']->created_at}}</p>
            @if($matriz['datos']->Tipomantenimento['tipo_mantenineto'] == 'Mantenimiento 1' ||
                ...
                <p><strong>Precio Subtotal:</strong> {{$matriz['datos']->Tipomantenimento['precio']}}</p>
                <p><strong>IVA:</strong> {{($matriz['datos']->Tipomantenimento['precio']*0.12)}}</p>
                <p><strong>Precio Total:</strong> {{$matriz['datos']->Tipomantenimento['precio']+($matriz['datos']->Tipomantenimento['precio']*0.12)}}</p>
            @endif
        </div>
    </div>
